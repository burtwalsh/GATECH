...
class Stats
{
	...
	public static Set<Float> mode(List<Float> m) {
              ...
              System.out.println(max_appearance);
              if (max_appearance < 2) {
                 Set<Float> p = new HashSet<Float>();
                 p.add(Float.NaN);
                 return p;
...
public class O
{
 	...
 	public static void main(String[] args) {
                ...
                lf.add(new Float(20));
                lf.add(new Float(12));
                System.out.println(Stats.mean(lf));
                System.out.println(Stats.median(lf));
                lf.add(new Float(22));
                lf.add(new Float(22));
                System.out.println(Stats.median(lf));
                System.out.println(Stats.mode(lf));
        }
}
